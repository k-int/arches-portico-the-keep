"""
Django settings for arches_keep_app project.
"""
...
DATATYPE_LOCATIONS.append("arches_keep_app.datatypes")
FUNCTION_LOCATIONS.append("arches_keep_app.functions")
ETL_MODULE_LOCATIONS.append("arches_keep_app.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_keep_app.search_components")
...
SECRET_KEY = "django-insecure-57dfq#_n=3$hmpb2k8lto)ej!7rrtp*&6^la$ihud*48lbnt42"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_keep_app.urls"
ROOT_HOSTCONF = "arches_keep_app.hosts"

DEFAULT_HOST = "arches_keep_app"
...
ELASTICSEARCH_PREFIX = "arches_keep_app"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_keep_app.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_keep_app",  # Ensure the project is listed before any other arches applications
    "arches_her",
)
...
WSGI_APPLICATION = "arches_keep_app.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_keep_app"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_keep_app.search.es_mapping_modifier.EsMappingModifier"]
...
try:
    ...
    try:
        from arches_keep_app.settings_local import *
    except ImportError as e:
        pass
